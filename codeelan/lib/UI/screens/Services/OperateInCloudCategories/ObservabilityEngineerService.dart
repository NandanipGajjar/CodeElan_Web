...
import 'package:flutter/material.dart';
 import '../../../../DataObjects/ServiceData/OperateInCloudData/ObservabilityEngineerData.dart';
import '../../../../DataObjects/TestimonialListData.dart';
import '../../../../Utils/Responsive.dart';
import '../../../../Utils/widgets.dart';

class ObservabilityEngineeringService extends StatefulWidget {
  const ObservabilityEngineeringService({Key? key}) : super(key: key);

  @override
  State<ObservabilityEngineeringService> createState() =>
      _ObservabilityEngineeringServiceState();
}

class _ObservabilityEngineeringServiceState
    extends State<ObservabilityEngineeringService>
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      width: width * .35,
                                      child: Text(
                                        'Building observability into your cloud infrastructure and applications enables you to gain valuable insights into their performance, availability, and user experience.Our Observability Engineering services focus on designing and implementing observability solutions tailored to your specific needs. We combine advanced monitoring, tracing, and logging techniques with our expertise, to help you understand the behavior of your systems, identify performance bottlenecks, and drive continuous improvement for optimal cloud operations.',
                                        style: TextStyle(
                                            color: Colors.white,
                                            fontFamily: 'Arial',
                                            fontSize: 16,
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        children: [
                          ServicesGrid(
                              observabilityEngineeringList[0].icon,
                              observabilityEngineeringList[0].title,
                              observabilityEngineeringList[0].subTitle),
                          SizedBox(
                            height: height * .02,
                          ),
                          ServicesGrid(
                              observabilityEngineeringList[2].icon,
                              observabilityEngineeringList[2].title,
                              observabilityEngineeringList[2].subTitle),
                          SizedBox(
                            height: height * .02,
                          ),
                          ServicesGrid(
                              observabilityEngineeringList[4].icon,
                              observabilityEngineeringList[4].title,
                              observabilityEngineeringList[4].subTitle)
                        ],
                      ),
                    ),
                    SizedBox(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ServicesGrid(
                              observabilityEngineeringList[1].icon,
                              observabilityEngineeringList[1].title,
                              observabilityEngineeringList[1].subTitle),
                          SizedBox(
                            height: height * .02,
                          ),
                          ServicesGrid(
                              observabilityEngineeringList[3].icon,
                              observabilityEngineeringList[3].title,
                              observabilityEngineeringList[3].subTitle),
                          SizedBox(
                            height: height * .02,
                          ),
                          ServicesGrid(
                              observabilityEngineeringList[5].icon,
                              observabilityEngineeringList[5].title,
                              observabilityEngineeringList[5].subTitle),
                        ],
                      ),
                    ),
                  ],
                          ...
                          child: Column(
                            children: [
                              howWorkWidget(
                                ...
                                'Our observability engineers conduct a thorough assessment of your existing infrastructure and applications, understanding your specific objectives and requirements to develop a tailored observability strategy.',
                              ),
                              howWorkWidget(
                                'Tool Selection And Implementation',
                                'Based on the assessment, we recommend and implement the most suitable observability tools and platforms, configuring them to collect and analyze relevant data from your cloud environment.',
                              ),
                              howWorkWidget(
                                'Data Collection And Analysis',
                                'We set up data collection mechanisms, integrate with your systems and services, and continuously collect and analyze observability data, generating actionable insights and visualizations.',
                              ),
                              howWorkWidget(
                                  'Performance Optimization And Continuous Improvement',
'Our team collaborates with you to identify areas for performance optimization, implement necessary changes, and drive continuous improvement through iterative monitoring and analysis.'),                            ],
                          )),
                    ),
                    SizedBox(
                      width: width * .1,
...
'Our observability engineers possess deep knowledge and expertise in designing and implementing observability solutions, leveraging industry best practices to ensure accurate monitoring and actionable insights.',                    ),
                  ),
                  SizedBox(
                    width: width * .01,
                  ),
              ...
              Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  ExclusiveContainer('Customized Approach',
'We understand that each business has unique needs, and we provide tailored observability engineering services that align with your specific infrastructure, applications, and objectives.',),
                  SizedBox(
                    width: width * .01,
                  ),
                  ExclusiveContainer('Collaboration And Knowledge Transfer',
'We work closely with your teams, fostering collaboration and knowledge transfer to empower your organization with the skills and understanding needed to manage and optimize observability in the long run.',),                ],
              ),
              SizedBox(
                height: height * .03,
              ),
...
'Our observability engineering services focus on proactively identifying and resolving issues, minimizing downtime, and optimizing performance for uninterrupted operations.'),
                ],
              )
            ],
          )
