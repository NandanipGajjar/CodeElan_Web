...
class ProductDevelopmentServices extends StatefulWidget {
  const ProductDevelopmentServices({Key? key}) : super(key: key);

  @override
  State<ProductDevelopmentServices> createState() =>
      _ProductDevelopmentServicesState();
}

class _ProductDevelopmentServicesState extends State<ProductDevelopmentServices>
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        children: [
                          ServicesGrid(
                              productCloudServiceList[0].icon,
                              productCloudServiceList[0].title,
                              productCloudServiceList[0].subTitle),
                          SizedBox(
                            height: height * .02,
                          ),
                          ServicesGrid(
                              productCloudServiceList[2].icon,
                              productCloudServiceList[2].title,
                              productCloudServiceList[2].subTitle),
                          SizedBox(
                            height: height * .02,
                          ),
                          ServicesGrid(
                              productCloudServiceList[4].icon,
                              productCloudServiceList[4].title,
                              productCloudServiceList[4].subTitle)
                        ],
                      ),
                    ),
                    SizedBox(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ServicesGrid(
                              productCloudServiceList[1].icon,
                              productCloudServiceList[1].title,
                              productCloudServiceList[1].subTitle),
                          SizedBox(
                            height: height * .02,
                          ),
                          ServicesGrid(
                              productCloudServiceList[3].icon,
                              productCloudServiceList[3].title,
                              productCloudServiceList[3].subTitle),
                        ],
                      ),
                    ),
                  ],
                          ...
                          child: Column(
                            children: [
                              howWorkWidget(
                                  ...
                                  'Our team collaborates with you to understand your vision, target audience, and specific requirements, setting the foundation for product development.'),
                              howWorkWidget('Agile Development Sprints',
                                  'We employ agile methodologies, breaking down the development process into iterative sprints, ensuring regular feedback, and continuous improvement.'),
                              howWorkWidget('Prototyping And Design',
                                  "We create prototypes and wireframes to visualize the product's functionality and user experience, collaborating with you to refine the design and user interface."),
                              howWorkWidget('Development And Testing',
                                  "Our skilled developers bring your product to life, ensuring seamless integration of features and functionalities. Rigorous testing and quality assurance processes are followed throughout development to deliver a robust and reliable product.")
                            ],
                          )),
                    ),
                    SizedBox(
              ...
              : Column(
                  ...
                  children: [
                    SizeTransition(
                      ...
                      child: Column(
                        children: [
                          howWorkWidget('Discovery And Requirement Gathering',
                              'Our team collaborates with you to understand your vision, target audience, and specific requirements, setting the foundation for product development.'),
                          howWorkWidget('Agile Development Sprints',
                              'We employ agile methodologies, breaking down the development process into iterative sprints, ensuring regular feedback, and continuous improvement.'),
                          howWorkWidget('Prototyping And Design',
